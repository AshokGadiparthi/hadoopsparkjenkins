...
System.out.println("TopNLocationByTweets.... data "+ data);
System.out.println("TopNLocationByTweets.... data "+ data + " after string "+(String) data[1]);			
return new Tuple2<String, Integer>((String) data[6], 1);
