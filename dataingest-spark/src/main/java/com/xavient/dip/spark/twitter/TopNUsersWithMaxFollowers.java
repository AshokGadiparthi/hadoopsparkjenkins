...
System.out.println("TopNUsersWithMaxFollowers ... data "+ data);
System.out.println("TopNUsersWithMaxFollowers ... data "+ data + " after string .. "+(String) data[2]);			
//return new Tuple2<String, Integer>((String) data[5], new Integer(10)]);
return new Tuple2<String, Integer>((String) data[5], 1);
		});
	}
}
